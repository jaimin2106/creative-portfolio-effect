...
const PremiumServices = () => {
  ...
  return (
    <section id="services" className="min-h-screen py-40 px-6 relative overflow-hidden bg-black">
      ...
      <div className="container mx-auto max-w-none relative z-10">
        ...
        >
          ...
          <h2 className="text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-12 font-playfair leading-tight tracking-tight">
            Exquisite
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h3 className="text-5xl md:text-6xl font-bold text-white mb-8 font-playfair leading-tight">
              Ready to Create

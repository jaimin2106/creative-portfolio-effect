  ...
  return (
    <div className="sm-scope w-full h-full">
      ...
      >
        ...
        >
          {(() => {
            const raw = colors && colors.length ? colors.slice(0, 4) : ['#000000', '#111111'];
            let arr = [...raw];
            if (arr.length >= 3) {
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className="sm-toggle relative inline-flex items-center gap-[0.3rem] bg-transparent border-0 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto text-sm"
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full bg-black/95 backdrop-blur-xl flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10"
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-medium text-white">Connect</h3>
                <ul
                  ...
                  {socialItems.map((s, i) => (
                    <li key={s.label + i} className="sm-socials-item">
                      <a
                        ...
                        className="sm-socials-link text-[1.2rem] font-medium text-white/70 hover:text-white no-underline relative inline-block py-[2px] transition-[color,opacity] duration-300 ease-linear"
                      >
                        {s.label}
                      </a>
                    </li>
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid white; outline-offset: 3px; }
...
.sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after { counter-increment: smItem; content: counter(smItem, decimal-leading-zero); position: absolute; top: 0.1em; right: 3.2em; font-size: 18px; font-weight: 400; color: rgba(255, 255, 255, 0.5); letter-spacing: 0; pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0); }
@media (max-width: 1024px) { 
  .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; } 
  .sm-scope .staggered-menu-wrapper[data-open] .sm-logo { filter: invert(0%); }
